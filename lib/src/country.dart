...
List<Country> countries = [
  Country("Afghanistan", "AF", "+93", 7, 9),
  Country("Albania", "AL", "+355", 8, 9),
  Country("Algeria", "DZ", "+213", 9, 9),
  Country("Andorra", "AD", "+376", 6, 6),
  Country("Angola", "AO", "+244", 9, 9),
  Country("Argentina", "AR", "+54", 9, 11),
  Country("Armenia", "AM", "+374", 8, 9),
  ...
  Country("Bhutan", "BT", "+975", 7, 8),
  Country("Bolivia", "BO", "+591", 8, 9),
  Country("Bosnia and Herzegovina", "BA", "+387", 8, 10),
  Country("Botswana", "BW", "+267", 7, 10),
  Country("Brazil", "BR", "+55", 10, 11),
  Country("Brunei", "BN", "+673", 7, 10),
  Country("Bulgaria", "BG", "+359", 9, 10),
  Country("Burkina Faso", "BF", "+226", 8, 10),
  Country("Burundi", "BI", "+257", 8, 10),
  Country("Cambodia", "KH", "+855", 8, 10),
  Country("Cameroon", "CM", "+237", 9, 10),
  Country("Canada", "CA", "+1", 10, 10),
  Country("Cape Verde", "CV", "+238", 7, 7),
  Country("Central African Republic", "CF", "+236", 8, 8),
  Country("Chad", "TD", "+235", 6, 8),
  Country("Chile", "CL", "+56", 9, 9),
  Country("China", "CN", "+86", 11, 11),
  Country("Colombia", "CO", "+57", 10, 10),
  Country("Comoros", "KM", "+269", 7, 7),
  Country("Congo (DRC)", "CD", "+243", 7, 9),
  Country("Congo (Republic)", "CG", "+242", 7, 9),
  ...
  Country("Djibouti", "DJ", "+253", 8, 10),
  Country("Dominica", "DM", "+1-767", 8, 10),
  ...
  Country("Guinea-Bissau", "GW", "+245", 7, 9),
  ...
  Country("Madagascar", "MG", "+261", 7, 9),
  Country("Malawi", "MW", "+265", 7, 9),
  Country("Malaysia", "MY", "+60", 7, 9),
  Country("Maldives", "MV", "+960", 7, 7),
  Country("Mali", "ML", "+223", 8, 9),
  ...
  Country("Mozambique", "MZ", "+258", 9, 12),
  Country("Myanmar", "MM", "+95", 7, 10),
  Country("Namibia", "NA", "+264", 7, 9),
  Country("Nauru", "NR", "+674", 7, 7),
  Country("Nepal", "NP", "+977", 10, 10),
  Country("Netherlands", "NL", "+31", 9, 10),
  Country("New Zealand", "NZ", "+64", 8, 10),
  Country("Nicaragua", "NI", "+505", 8, 9),
  Country("Niger", "NE", "+227", 8, 9),
  Country("Nigeria", "NG", "+234", 8, 10),
  Country("North Macedonia", "MK", "+389", 8, 9),
  ...
  Country("Saint Lucia", "LC", "+1-758", 7, 10),
  Country("Saint Vincent and the Grenadines", "VC", "+1-784", 7, 10),
  Country("Samoa", "WS", "+685", 5, 7),
